...
<body style="text-align: center;">
    ...
    <form action="add" class=".form-control-large">
        <input type="text" name="id" class=".form-control-large" style="text-align: center; border-radius: 5px;"
            placeholder="Serial Number"><br>
        <input type="text" name="name" style="text-align: center; border-radius: 5px;" placeholder="Alien Name"><br>
